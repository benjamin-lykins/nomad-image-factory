data "hcp-packer-artifact" "vsphere-docker" {
  bucket_name   = "vsphere-docker"
  channel_name  = "latest"
  platform      = "vsphere"
  region        = "Datacenter"
}
...
source "vsphere-clone" "nomad-server" {
  ...
  vm_name              = "${local.vm_name}-server"
  template             = data.hcp-packer-artifact.vsphere-docker.external_identifier
...
source "vsphere-clone" "nomad-client" {
  // vCenter Server Endpoint Settings and Credentials
  vcenter_server      = var.vsphere_server
  username            = var.vsphere_username
  password            = var.vsphere_password
...
source "vsphere-clone" "nomad-shared" {
  // vCenter Server Endpoint Settings and Credentials
  vcenter_server      = var.vsphere_server
  username            = var.vsphere_username
  password            = var.vsphere_password
